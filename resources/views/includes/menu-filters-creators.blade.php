@if (! request()->get('q') || request()->get('q') && strlen(request()->get('q')) <= 2)
  ...
  <button type="button" class="btn-menu-expand btn btn-primary btn-block mb-4 d-none" type="button" data-toggle="collapse" data-target="#navbarFilters" aria-controls="navbarCollapse" aria-expanded="false">
      <i class="bi bi-filter-right mr-2"></i> {{trans('general.filter_by')}}
    </button>

<div class="navbar-collapse collapse d-none" id="navbarFilters">
