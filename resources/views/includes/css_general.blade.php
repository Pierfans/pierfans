...
@media (max-width: 991px) {
  .navbar .navbar-collapse, .dropdown-item.balance:hover
  ...
  /* Fixar rodapé na parte inferior em dispositivos móveis na página de parcerias */
  body:has(section.container[style*="min-height: 75vh"]) {
    display: flex;
    flex-direction: column;
    min-height: 100vh;
  }
  
  body:has(section.container[style*="min-height: 75vh"]) section.container {
    flex: 1;
  }
  }
...
.dropdown-menu-right.dd-menu-user {
...
@media (max-width: 767px) {
  ...
  /* Fix for About Me section in mobile */
  #navbarUserHome.show {
    display: block !important;
  }
  
  /* Fix for filters in Explore section */
  #navbarFilters.show {
    display: block !important;
  }
  
  /* Fix for categories in Explore section */
  #navbarCategories.show {
    display: block !important;
  }
