<button type="button" class="btn-menu-expand btn btn-primary btn-block mb-4 d-none" type="button" data-toggle="collapse" data-target="#navbarUserHome" aria-controls="navbarCollapse" aria-expanded="false">
		<i class="fa fa-bars mr-2"></i> {{trans('general.categories')}}
	</button>

	<div class="navbar-collapse collapse d-none" id="navbarUserHome">

		<span class="category-filter d-none">
