@if ($mediaImageVideoTotal == 1)
	...
	<a href="{{ $urlImg }}" class="glightbox w-100" data-gallery="allphotos">
...
@foreach ($mediaImageVideo as $media)
	...
	@endphp
		...
		@if ($media->type == 'image' || $media->type == 'video')
			<a href="{{ $urlMedia }}" class="media-wrapper rounded-0 glightbox" data-gallery="allphotos" style="background-image: url('{{ $videoPoster ?? $urlMedia}}?w=960&h=980')">
