...
@foreach ($mediaImageVideo as $media)
	...
	@if ($media->type == 'image')
		<div class="media-grid-1">
			<a href="{{ $urlImg }}" class="media-wrapper glightbox {{$styleImgVertical}}" data-gallery="allphotos" style="background-image: url('{{$urlImg}}?w=960&h=980')">
...
@foreach ($mediaImageVideo as $media)
	...
	@endphp
		...
		@if ($media->type == 'image' || $media->type == 'video')
			...
			<a href="{{ $urlMedia }}" class="media-wrapper glightbox" data-gallery="allphotos" style="background-image: url('{{ $videoPoster ?? $urlMedia }}?w=960&h=980')">
