      ...
      <div class="offcanvas-body px-0 scrollbar">
          <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-start list-sidebar" id="menu">
            ...
            @endif
              ...
              @if (auth()->user()->hasPermission('topCriadores'))
                  <li class="nav-item">
                      <a href="{{ url('panel/admin/top-creadores') }}" class="nav-link text-truncate @if (request()->is('panel/admin/top-creadores')) active @endif">
                          <i class="bi-star me-2"></i> Top Creadores
                      </a>
                  </li>
              @endif

              @if (auth()->user()->hasPermission('initial_posts'))
                  <li class="nav-item">
                      <a href="{{ url('panel/admin/initial-posts') }}" class="nav-link text-truncate @if (request()->is('panel/admin/initial-posts')) active @endif">
                          <i class="bi-pencil-square me-2"></i> Initial Posts
                      </a>
                  </li>
              @endif
